...
// Hook to fetch a specific shopping list with its items
...
// Hook to get a list of all shopping lists
export const useShoppingListsList = () => {
  const { user } = useAuth();
...
// Mutation hook to add a shopping list
...
// Mutation hook to add a shopping list item
...
// Mutation hook to update a shopping list item
...
// Mutation hook to delete a shopping list item
