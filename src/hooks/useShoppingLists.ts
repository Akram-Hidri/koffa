...
export const useShoppingLists = () => {
  ...
  return {
    // Add this method to fix the error in RecipeDetailPage.tsx
    useShoppingListsList: () => useQuery({
      queryKey: ['shoppingLists', user?.id],
      queryFn: fetchShoppingLists,
      enabled: !!user,
    }),
    
    useShoppingListWithItems: (listId: string) => useQuery({
    ...
    useAddShoppingList: () => useMutation({
    ...
    useAddShoppingListItem: () => useMutation({
    ...
    useUpdateShoppingListItem: () => useMutation({
    ...
    useDeleteShoppingListItem: () => useMutation({
